...
class _SafetytipsState extends State<Safetytips> {
  ...
  void initState() {
    ...
    _controller1 = VideoPlayerController.networkUrl(
      'https://www.youtube.com/watch?v=K3kn_V8RTbs' as Uri,
    );
    _controller2 = VideoPlayerController.networkUrl(
      'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4' as Uri,
    );
    _controller3 = VideoPlayerController.networkUrl(
      'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4' as Uri,
    );
    _controller4 = VideoPlayerController.networkUrl(
      'https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4' as Uri,
    );
